...
final class Version20260528052158 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice (id INT AUTO_INCREMENT NOT NULL, number VARCHAR(30) NOT NULL, amount NUMERIC(8, 2) NOT NULL, status VARCHAR(20) NOT NULL, stripe_payment_intent_id VARCHAR(255) DEFAULT NULL, stripe_checkout_session_id VARCHAR(255) DEFAULT NULL, paid_at DATETIME DEFAULT NULL, signature_token VARCHAR(64) DEFAULT NULL, signature_data LONGTEXT DEFAULT NULL, signed_at DATETIME DEFAULT NULL, created_at DATETIME NOT NULL, booking_id INT NOT NULL, UNIQUE INDEX UNIQ_9065174496901F54 (number), UNIQUE INDEX UNIQ_90651744D7605360 (signature_token), INDEX IDX_906517443301C60 (booking_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
